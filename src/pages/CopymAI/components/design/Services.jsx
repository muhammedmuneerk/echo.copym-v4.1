  ...
  return (
    <div className="absolute top-8 right-8 w-[18rem] h-[6rem] py-6 px-8 bg-black rounded-t-xl rounded-bl-xl font-code text-base lg:top-16 lg:right-[8.75rem]">
      <Typewriter
        options={{
          strings: [
            "Hey COPYM-AI, enhance this Dashboard.",
            "Hey COPYM-AI, give this chart a boost.",
            "COPYM-AI, enhance the details in this Dashboard.",
            "Activate COPYM-AI mode to refine this Dashboard.",
            "COPYM-AI, apply your magic to this Dashboard.",
          ],
          autoStart: true,
          loop: true,
        }}
